from db import insert_db_purchase_lotto_numbers, insert_db_lotto_numbers
from db import truncate_db_lotto_numbers, truncate_db_purchase_numbers
from services import CheckWinningStatus
